...
class PW_CMB2_Field_Google_Maps {
	...
	public function setup_admin_scripts() {
		wp_register_script( 'pw-google-maps-api', '//maps.googleapis.com/maps/api/js?sensor=false&libraries=places&key=AIzaSyD3OwYu6wRQx7IbGSS84dShb5bvlIplxJY', null, null );
